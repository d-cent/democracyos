...
UserProfile.prototype.shouldShowEdition = function (userId) {
  if (citizen.id === userId) {
    ...
    o('button, #user-profile-wrapper .profile-container h2, #user-profile-wrapper .profile-container img, #user-profile-wrapper .about-container, #user-profile-wrapper .tags-container', this.el).on('click', function () {
      self.toggle();
