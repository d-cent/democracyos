 ...
 * Constructor
 *
 * Create a basic view to be merge in to the
 *
 * @param {jade} template Current page template.
 * Should be come from a jade file. can't be null.
 *
 * @param {Object} locals object with data to fill the template. Optional.
 */
